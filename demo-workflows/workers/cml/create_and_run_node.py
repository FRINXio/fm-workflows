...
class CreateAndRunNode:
    def __init__(self, node_name: str, x, y,ip_address: str ,token: str):
        ...
        self.node_id = self.create_node(node_name, x, y)
        self.update_node_config()
        self.run_node()

    def create_node(self, node_name: str, x: int, y: int) -> str:
        """ Return ex. : "c1624ab-6ac3-476d-805c-180270407022" """
        NODE_CONFIG["label"] = node_name
        NODE_CONFIG["x"] = x
        NODE_CONFIG["y"] = y
    ...
    def update_node_config(self):
        ...
        configuration = {"configuration": UBUNTU_NODE_CONFIGURATION.format(ip_address=self.ip_address)}
