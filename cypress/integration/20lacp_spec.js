...
describe('LACP workflows', function() {
  ...
  it('creating a link aggregation between two nodes', function() {
    ...
    //20200903 FM-499  cy.contains('XR01').click()
    cy.contains('node1').next().type('XR01')
    ...
    //20200903 FM-499  cy.contains('XR02').click() //choose from autocomplete combo box by clicking
    cy.get('@node2').type('XR02')
